...
def main():
    ...
    command = 'rosrun tf2_ros static_transform_publisher '\
        '%f %f %f %f %f %f %s %s' % (transform_stamped['transform']['translation']['x'],
                                        transform_stamped['transform']['translation']['y'],
                                        transform_stamped['transform']['translation']['z'],
                                        transform_stamped['transform']['rotation']['yaw'],
                                        transform_stamped['transform']['rotation']['pitch'],
                                        transform_stamped['transform']['rotation']['roll'],
                                        transform_stamped['header']['frame_id'],
                                        transform_stamped['child_frame_id'])

    # command = 'rosrun tf2_ros static_transform_publisher 0.0 0.0 0.0 0.0 3.14 0.0 velodyne body'
    # # '%f %f %f %f %f %f %s %s' % (transform_stamped['transform']['translation']['x'],
    # #                                 transform_stamped['transform']['translation']['y'],
    # #                                 transform_stamped['transform']['translation']['z'],
    # #                                 transform_stamped['transform']['rotation']['yaw'],
